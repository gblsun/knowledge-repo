...
→ Crie um pacote chamado calculadora. Dentro deste pacote, inclua três módulos: padrao, cientifica e trigonometrica. As funcionalidades de cada módulo são:
    ...
    ↳ Científica: deve disponibilizar funções de exponenciação e logaritmo

    ↳ Trigonométrica: deve disponibilizar funções de seno, cosseno e tangente

→ Crie um módulo principal (main.py) e teste as funcionalidades dos seus módulos. Explore os recursos de alias, importação de partes dos seus módulos, etc.
'''
