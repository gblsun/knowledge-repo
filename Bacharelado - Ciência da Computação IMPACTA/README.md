# Bacharelado em Ciência da Computação — IMPACTA

Materiais, exercícios e projetos do curso de Bacharelado em Ciência da Computação da Faculdade IMPACTA, organizados por semestre.

## Semestres

- [1º Semestre](./1%20Semestre/) — Linguagem de Programação
- [2º Semestre](./2%20Semestre/) — Matemática para Computação, Técnicas de Programação
